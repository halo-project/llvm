...
set(ALL_HALOMON_SUPPORTED_ARCH ${X86_64} ${ARM32})
...
if(APPLE)
  ...
  list_intersect(PROFILE_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(HALOMON_SUPPORTED_ARCH
    ALL_HALOMON_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(HALOMON_SUPPORTED_ARCH ${ALL_HALOMON_SUPPORTED_ARCH})
...
if (HALOMON_SUPPORTED_ARCH AND COMPILER_RT_HAS_SANITIZER_COMMON AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_HALOMON TRUE)
else()
  set(COMPILER_RT_HAS_HALOMON FALSE)
endif()
