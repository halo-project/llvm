...
set(ALL_PROFILE_SUPPORTED_ARCH ${X86} ${X86_64} ${ARM32} ${ARM64} ${PPC64}
    ${MIPS32} ${MIPS64} ${S390X})
set(ALL_HALO_SUPPORTED_ARCH ${X86_64} ${ARM32})
...
if(APPLE)
  ...
  list_intersect(PROFILE_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(HALO_SUPPORTED_ARCH
    ALL_HALO_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(HALO_SUPPORTED_ARCH ${ALL_HALO_SUPPORTED_ARCH})
...
if (HALO_SUPPORTED_ARCH AND COMPILER_RT_HAS_SANITIZER_COMMON AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_HALO TRUE)
else()
  set(COMPILER_RT_HAS_HALO FALSE)
endif()
